...
Work in progress. This repository will include SQL/Python analysis, a segmentation approach, and final recommendations.
...
- `sql/` — queries / notes
- `data/` — notes and small samples (full dataset is kept local)
- `images/` — key charts / dashboard screenshots
